...
const changepasswordApi = ( changePasswordDto : ChangePasswordDto ) : Promise<AxiosResponse<ChangePasswordDto>> =>{
...
export { getPasswordByID, createPasswordSetting, updatePasswordSetting, getAllPasswordSetting, changepasswordApi, getPasswordPolicy };
